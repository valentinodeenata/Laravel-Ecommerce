...
Route::group(['middleware' => ['auth', 'checkRole:customer']], function () {
    ...
    Route::get('toko', 'user\SellerController@index')->name('user.dashboard');
    ...
    Route::get('toko/daftartoko', 'user\StoreController@index')->name('user.bukatoko');
    Route::post('toko/actionbuattoko', 'user\StoreController@daftartoko')->name('user.actionbuattoko');
    Route::get('/toko/edittoko', 'user\StoreController@edit_toko')->name('seller.edit_toko');
    Route::post('toko/edittoko/action', 'user\StoreController@edit_tokoAction')->name('seller.edit_toko.action');

    Route::get('toko/transaksi', 'user\TransaksiController@index')->name('seller.transaksi');
    Route::get('toko/transaksi/perludicek', 'user\TransaksiController@perludicek')->name('seller.transaksi.perludicek');
    Route::get('/toko/transaksi/perludikirim', 'user\TransaksiController@perludikirim')->name('seller.transaksi.perludikirim');
    Route::get('/toko/transaksi/dikirim', 'user\TransaksiController@dikirim')->name('seller.transaksi.dikirim');
    Route::get('/toko/transaksi/selesai', 'user\TransaksiController@selesai')->name('seller.transaksi.selesai');
    Route::get('/toko/transaksi/dibatalkan', 'user\TransaksiController@dibatalkan')->name('seller.transaksi.dibatalkan');
    Route::get('/toko/transaksi/konfirmasi/{id}', 'user\TransaksiController@konfirmasi')->name('seller.transaksi.konfirmasi');
    Route::post('/toko/transaksi/inputresi/{id}', 'user\TransaksiController@inputresi')->name('seller.transaksi.inputresi');
    Route::get('toko/transaksi/{id}', 'user\TransaksiController@detail')->name('seller.transaksi.detail');

    Route::get('/toko/product', 'user\ProductController@index')->name('seller.product');
    Route::get('/toko/product/tambah', 'user\ProductController@tambah')->name('seller.product.tambah');
    Route::post('/toko/product/store', 'user\ProductController@store')->name('seller.product.store');
    Route::get('/toko/product/edit/{id}', 'user\ProductController@edit')->name('seller.product.edit');
    Route::get('/toko/product/delete/{id}', 'user\ProductController@delete')->name('seller.product.delete');
    Route::post('/toko/product/update/{id}', 'user\ProductController@update')->name('seller.product.update');
});
