...
class TransaksiController extends Controller
{
    public function index()
    {
        ...
        // dd($order);
        return view('user.seller.transaksi.index', $data);
    }
    ...
    public function detail($id)
    {
        ...
        return view('user.seller.transaksi.detail', $data);
    }
    ...
    public function perludicek()
    {
        ...
        return view('user.seller.transaksi.perludicek', $data);
    }
    ...
    public function perludikirim()
    {
        ...
        return view('user.seller.transaksi.perludikirim', $data);
    }
    ...
    public function dikirim()
    {
        ...
        return view('user.seller.transaksi.dikirim', $data);
    }
    ...
    public function selesai()
    {
        ...
        return view('user.seller.transaksi.selesai', $data);
    }
    ...
    public function dibatalkan()
    {
        ...
        return view('user.seller.transaksi.dibatalkan', $data);
    }
    ...
    public function konfirmasi($id)
    {
        ...
        return redirect()->route('user.seller.transaksi.perludikirim')->with('status', 'Berhasil Mengonfirmasi Pembayaran Pesanan');
    }
    ...
    public function inputresi($id, Request $request)
    {
        ...
        $order->save();
        return redirect()->route('seller.transaksi.perludikirim')->with('status', 'Berhasil Menginput No Resi');
    }
}
