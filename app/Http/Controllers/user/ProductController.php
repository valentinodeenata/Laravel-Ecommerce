...
class ProductController extends Controller
{
    public function index()
    {
        ...
        return view('user.seller.product.index', $data);
    }
    ...
    public function tambah()
    {
        ...
        return view('user.seller.product.tambah', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('image')) {
            ...
            return redirect()->router('seller.product')->with('status', 'Berhasil Menambah Produk Baru');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('user.seller.product.edit', $data);
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->router('seller.product')->with('status', 'Berhasil Mengubah Kategori');
    }
    ...
    public function delete($id)
    {
        ...
        Product::destroy($id);
        Storage::delete('public/' . $prod->image);
        return redirect()->router('seller.product')->with('status', 'Berhasil Mengahapus Produk');
    }
}
