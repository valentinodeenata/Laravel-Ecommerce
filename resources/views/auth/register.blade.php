          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              <div class="brand-logo">
                <img src="{{ asset('adminassets') }}/assets/images/logo_icon_new.jpeg">
              </div>
              <h4>Mau Membuat Akun?</h4>
              <h6 class="font-weight-light">Ayo Daftar! Caranya Sangatlah Mudah!</h6>
                ...
                <div class="mb-4">
                  <div class="form-check">
                    <label class="form-check-label text-muted">
                      <input type="checkbox" class="form-check-input"> Saya Setuju Mengenai Syarat dan Ketentuan. </label>
                  </div>
                </div>
                <div class="mt-3">
