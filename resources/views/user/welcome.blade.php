@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/rsz_yellow.jpg);" data-aos="fade">
    <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
            <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                <h1 class="mb-2">Cari Kebutuhan Hobi Kamu Disini! Dan Temukan Jati Dirimu!</h1>
                <div class="intro-text text-center text-md-left">
                    <p class="mb-4">Semua Kualitas Barang yang Kami Jual Terjamin Kualitasnya dan Original </p>
                    <p>
