                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td  class="p-2"><a href="{{ route('seller.transaksi.konfirmasi',['id' => $order->id]) }}" onclick="return confirm('Yakin ingin mengonfirmasi pesanan ini?')" class="btn btn-primary mt-1">Konfirmasi Telah Bayar</a><br>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td  class="p-2">
                            <form action="{{ route('seller.transaksi.inputresi',['id' => $order->id]) }}" method="POST">
                                @csrf
